...
class FileUtilitiesUI:
    def __init__(self, root):
        ...
        # Detect current screen width and height 
        ...
        self.entry_output = tk.Entry(self.root, text="Generate", command=self.output_file)
        ...
        def generate_output(self):
            ...
            # To be added create a file with the name and the content 
            # Placeholder are below for display only 
            print("File 1:", file1)
            print("File 2:", file2)
